...
public interface AbcConstants {
	...
	int LONGEST_NOTE_MICROS_WORST_CASE = (2 * SHORTEST_NOTE_MICROS - 1) * (LONGEST_NOTE_MICROS / (2 * SHORTEST_NOTE_MICROS - 1));
	...
	double SUSTAINED_NOTE_HOLD_SECONDS = 0.06;// A little hold to get the release to sound more like lotros linear. Lowered to 0.06s from 0.1s in
												// 2.5.0
